    ...
    <main className="min-h-screen bg-[#050505] text-[#f0f0f0] font-sans selection:bg-[#00ff99] selection:text-[#050505] pt-32 pb-24 px-6 lg:px-12 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-20">
        ...
        <div className="space-y-12 font-sans text-base leading-relaxed text-white/80">
          <section>
            <h2 className="text-2xl font-black uppercase tracking-widest text-white mb-4 border-l-2 border-[#00ff99] pl-4">1. Information We Collect</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-black uppercase tracking-widest text-white mb-4 border-l-2 border-[#00ff99] pl-4">2. How We Use Your Data</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-black uppercase tracking-widest text-white mb-4 border-l-2 border-[#00ff99] pl-4">3. Data Sharing and Security</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-black uppercase tracking-widest text-white mb-4 border-l-2 border-[#00ff99] pl-4">4. Your Rights</h2>
            <p className="mb-8">
