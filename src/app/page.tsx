        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 w-full border border-white/20">
          ...
          >
            <div>
              ...
              <ul className="space-y-3 mb-12">
                <li className="font-mono text-[10px] text-current font-bold uppercase tracking-widest flex items-center gap-3"><TerminalSquare className="w-3 h-3 text-[#00bfff] group-hover:text-black shrink-0" /> Instant SMS Responder</li>
                <li className="font-mono text-[10px] text-current font-bold uppercase tracking-widest flex items-center gap-3"><TerminalSquare className="w-3 h-3 text-[#00bfff] group-hover:text-black shrink-0" /> Smart Follow-up Sequences</li>
                <li className="font-mono text-[10px] text-current font-bold uppercase tracking-widest flex items-center gap-3"><TerminalSquare className="w-3 h-3 text-[#00bfff] group-hover:text-black shrink-0" /> CRM Lead Syncing</li>
                <li className="font-mono text-[10px] text-current font-bold uppercase tracking-widest flex items-center gap-3"><TerminalSquare className="w-3 h-3 text-[#00bfff] group-hover:text-black shrink-0" /> Custom Text Templates</li>
              </ul>
            </div>
          ...
          >
            <div>
              ...
              <ul className="space-y-3 mb-12">
                ...
                <li className="font-mono text-[10px] text-[#050505] font-black uppercase tracking-widest flex items-center gap-3"><TerminalSquare className="w-3 h-3 text-[#050505] shrink-0" /> Autonomous 2-Way AI Texting</li>
                <li className="font-mono text-[10px] text-[#050505] font-black uppercase tracking-widest flex items-center gap-3"><TerminalSquare className="w-3 h-3 text-[#050505] shrink-0" /> Direct Calendar Booking</li>
                <li className="font-mono text-[10px] text-[#050505] font-black uppercase tracking-widest flex items-center gap-3"><TerminalSquare className="w-3 h-3 text-[#050505] shrink-0" /> Live Scope-of-Work Extraction</li>
                <li className="font-mono text-[10px] text-[#050505] font-black uppercase tracking-widest flex items-center gap-3"><TerminalSquare className="w-3 h-3 text-[#050505] shrink-0" /> Auto-Qualification Filtering</li>
              </ul>
            </div>
          ...
          >
            <div>
              ...
              <ul className="space-y-3 mb-12">
                <li className="font-mono text-[10px] text-current font-bold uppercase tracking-widest flex items-center gap-3"><TerminalSquare className="w-3 h-3 text-[#00bfff] group-hover:text-black shrink-0" /> Everything in Standard</li>
