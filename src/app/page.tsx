        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 w-full border border-white/20">
          ...
          >
            <div>
              ...
              <h3 className="text-3xl lg:text-4xl font-black uppercase tracking-tighter mb-4 font-[family-name:var(--font-orbitron)]">Essential</h3>
          ...
          >
            <div>
              ...
              <h3 className="text-3xl lg:text-4xl font-black uppercase tracking-tighter mb-4 font-[family-name:var(--font-orbitron)]">Professional</h3>
              ...
              <ul className="space-y-3 mb-12">
                <li className="font-mono text-[10px] text-[#050505] font-black uppercase tracking-widest flex items-center gap-3"><TerminalSquare className="w-3 h-3 text-[#050505]" /> Real-time Dialog</li>
          ...
          >
            <div>
              ...
              <h3 className="text-3xl lg:text-4xl font-black uppercase tracking-tighter mb-4 font-[family-name:var(--font-orbitron)]">Enterprise</h3>
