          ...
          >
            ...
            <div className="space-y-8">
              <div className="flex flex-col border-b border-white/10 pb-8">
                ...
                <span className="text-4xl md:text-5xl font-mono tracking-tighter text-white/80">{formatMoney(weeklyLost)}</span>
              </div>
              <div className="flex flex-col border-b border-white/10 pb-8">
                <span className="font-mono text-[10px] md:text-xs tracking-widest uppercase text-white/50 mb-2">Per Month</span>
                <span className="text-5xl md:text-6xl font-mono tracking-tighter text-white/90">{formatMoney(monthlyLost)}</span>
              </div>
